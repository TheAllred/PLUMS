...
export default function Home({ children }: { children: React.ReactNode }) {
  ...
  const [shopCart, setShopCart] = useState({ Search: "" });
  const handleChange = (e: any) => {
    let updatedValue = {};
    updatedValue = { Search: e.target.value };
  ...
  return (
    <>
      <Auth0Provider
        domain="dev-8hq21cpj6xz1v6v1.us.auth0.com"
        clientId="s72GqGCcVxx7N44bf3qDSRq4hn3811ky"
        authorizationParams={{
                      ...
                      <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-background px-6 pb-4">
                        <div className="flex h-16 shrink-0 items-center">
                          <img
                            ...
                            alt="PLUMS"
                          />
                          <h1 className="text-darkPurple font-logo p-3">
                            PLUMS
                          </h1>
                        </div>
                        <nav className="flex flex-1 flex-col fixed">
                          ...
                          >
                            <li>
                              <ul
                                role="list"
                                className="-mx-2 space-y-1 font-head"
                              >
                                {navigation.map((item) => (
                                  <li key={item.name}>
                                    <a
            ...
            <div className="lg:pl-72">
              <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                  ...
                  <h1>{JSON.stringify(shopCart, null, 2)}</h1>
